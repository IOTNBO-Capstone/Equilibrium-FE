...
const Footer = () => {
  return (
    <div className="footer">
      ...
      <section className="resources" data-cy='resources'>
        <div className="general" data-cy='general-resources'>
          <h3>General Mental Health</h3>
          <a href="https://www.mhanational.org/find-support-groups" className="webLink">Support Groups</a>
        </div>
        <div className="coping" data-cy='coping-resources'>
          <h3>Coping Skills</h3>
        ...
        <div className="help-lines" data-cy='help-lines-resources'>
          <h3>Help Lines</h3>
